...
import { Broker } from '@mimosa/method-interceptor';
import { Application as Base, ApplicationOptions as Options, ControllerClass } from '@mimosa/core';
import { compose } from '@mimosa/core/utils';
